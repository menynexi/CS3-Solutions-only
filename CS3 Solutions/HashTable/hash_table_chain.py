...
class HashTableChain:
    ...
    def h(self, key):
        if type(key)!=str : # the key is an integer (easy case)
    ...
    def insert(self,key,data=''):
        ...
        # Allows insertion of keys with no associated data, which is useful wehn implementing set operations
        b = self.h(key)
    ...
    def delete(self, key):
        # Deletes record with given key if it is in the table
